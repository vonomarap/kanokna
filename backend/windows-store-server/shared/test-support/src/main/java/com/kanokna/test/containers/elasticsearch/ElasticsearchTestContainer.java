 ...
 */
public final class ElasticsearchTestContainer extends AbstractTestContainer<ElasticsearchContainer> {
    ...
    private ElasticsearchTestContainer() {
        super(new ElasticsearchContainer(ELASTICSEARCH_IMAGE)
