...
public class EventSerializer {
    ...
    public QuoteCalculatedEvent toQuoteCalculatedEvent(com.kanokna.pricing_service.domain.event.QuoteCalculatedEvent event) {
    ...
    private EventMetadata buildMetadata(com.kanokna.pricing_service.domain.event.QuoteCalculatedEvent event) {
    ...
    private Money toMoney(com.kanokna.pricing_service.domain.model.Money money) {
