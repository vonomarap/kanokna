package com.kanokna.pricing_service.architecture;
...
@AnalyzeClasses(packages = "com.kanokna.pricing_service")
public class HexagonalArchitectureTest {
    ...
    @ArchTest
    static final ArchRule no_cycles = slices().matching("com.kanokna.pricing_service.(*)..")
