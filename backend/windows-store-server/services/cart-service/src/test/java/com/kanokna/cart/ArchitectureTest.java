...
class ArchitectureTest {
    ...
    static void setup() {
        ...
        importedClasses = HexagonalArchitectureRules.importClasses("com.kanokna.cart");
    }
    ...
    void noPackageCycles() {
        HexagonalArchitectureRules.noPackageCycles("com.kanokna.cart").check(importedClasses);
    }
