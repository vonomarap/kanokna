 ...
 */
public record SearchQuery(String queryText, int page, int pageSize, SortField sortField, SortOrder sortOrder,
                          List<FacetFilter> filters, PriceRange priceRange, Language language) {
  public SearchQuery(
    String queryText,
    int page,
    int pageSize,
  ...
  @Override
  public List<FacetFilter> filters() {
